...
1. Compare and contrast the Critical Path Method (CPM) and Program Evaluation and Review Technique (PERT) in decision-making.
2. What are the key time durations used in the PERT method? Justify the choice of expected time duration calculation in the context of probabilistic modelling.
3. Write the PERT algorithm to find the expected duration and variance of a non-repetitive project.
4. How can Gantt charts be used to identify potential scheduling conflicts and resource bottlenecks in campus projects?
5. The mean and standard deviation of project duration are 300 and 100 days, respectively. With proper assumptions, find the probability for (a) completing the project within 417 days, (b) not completing within 417 days, (c) completing the project within 183 days, and (d) not completing within 183 days.
6. A project composed of 12 activities has following schedule characteristics:


1.	Construct the network diagram
2.	Compute earliest and latest event time for each event
3.	Find EST, LST, EFT, and LFT values of all activities
4.	Find the critical path and project duration
...
5. A campus event planning project has resource constraints (only 2 project managers available). Create a resource-leveled Gantt chart using the following data.   
Activities with PM requirements:
i.	Planning: 2 PMs, 2 weeks
ii.	Vendor selection: 1 PM, 3 weeks
iii.	Logistics: 2 PMs, 2 weeks
iv.	Promotion: 1 PM, 4 weeks
v.	Execution: 2 PMs, 1 week.
Assume that planning is the predecessor for Vendor selection, Logistics, and Promotion.


6. The following table lists the jobs of a network along with their time estimates.

| Job | Duration (days) - a | Duration (days) - m | Duration (days) - b |
|-----|---------------------|---------------------|---------------------|
| 1-2 | 3 | 6 | 15 |
| 1-6 | 2 | 5 | 14 |
| 2-3 | 6 | 12 | 30 |
...
3.	What is the approximate probability that the jobs on the critical path will be completed in 41 days?
4.	What is the probability that the project will not be completed in 45 days?


7. A project composed of 12 activities has following schedule characteristics:
...
8. Explain the necessity of scheduling in project planning. Use a Gantt chart to visualize the critical activities, non-critical activities, and event slack for the following project. The duration of the activity in weeks is given in brackets.
...
9. For the library construction project, add probabilistic time estimates:
